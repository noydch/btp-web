                ...
                windowWidth < 480 ? (
                    filteredBanners?.map((item, index) => (
                        <div key={index}
                            ...
                            <div className='w-full container max-w-[360px] mx-auto sm:max-w-[600px] md:max-w-[720px] lg:max-w-[900px] xl:max-w-[1200px]'>
                    ...
                    (
                        filteredBanners?.map((item, index) => (
                            <div key={index}
                                className='pt-[80px] container max-w-[360px] mx-auto sm:max-w-[600px] md:max-w-[720px] lg:max-w-[900px] xl:max-w-[1200px] pb-10'>
                                <div className=' w-full '>
                                    <img src={item.image} alt=""
